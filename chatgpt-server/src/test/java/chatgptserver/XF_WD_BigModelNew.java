...
public class XF_WD_BigModelNew extends WebSocketListener {
    ...
    // 构造函数
    public XF_WD_BigModelNew(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
    ...
    public static void main(String[] args) throws Exception {
      ...
      while (true){
          if(totalFlag){
              ...
              for (int i = 0; i < 1; i++) {
                  totalAnswer="";
                  WebSocket webSocket = client.newWebSocket(request, new XF_WD_BigModelNew(i + "",
                          false));
              }
          }else{
              Thread.sleep(200);
